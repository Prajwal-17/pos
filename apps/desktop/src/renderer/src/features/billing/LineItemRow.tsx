            ...
            <div className="flex h-full items-center justify-between gap-2">
              {dragHandle && item.productSnapshot.trim() !== "" && !disableDrag ? (
                <GripVertical
                  ...
                  className="text-muted-foreground/60 hover:bg-accent hover:text-foreground active:bg-accent focus-visible:ring-ring visible cursor-grab rounded-lg focus-visible:ring-2 focus-visible:ring-offset-1 active:cursor-grabbing"
                  size={20}
                />
              ) : (
                <GripVertical
                  className="text-muted-foreground/60 hover:bg-accent hover:text-foreground invisible rounded-lg group-hover:visible hover:cursor-grab"
                  size={20}
                />
              )}
