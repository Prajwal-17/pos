...
const BillingHeader = () => {
  ...
  return (
    <section className="bg-card border-b-frame flex min-h-12 shrink-0 items-center border-b px-3 py-1.5">
      <div className="flex min-w-0 flex-1 items-center gap-2">
        ...
        <div className="flex shrink-0 items-baseline gap-1.5 pr-1">
          ...
          <span className="text-base font-bold tabular-nums">{transactionNo ?? "New"}</span>
        </div>
        ...
        {hasRealCustomer && (
          <span
            className={
              isDue
                ? "bg-destructive/10 text-destructive shrink-0 rounded-[var(--radius-control)] px-2 py-1 text-xs font-semibold tabular-nums"
                : "bg-muted text-muted-foreground shrink-0 rounded-[var(--radius-control)] px-2 py-1 text-xs font-semibold"
            }
          >
        ...
        <div className="bg-muted border-border flex shrink-0 items-center rounded-[var(--radius-control)] border p-0.5">
          <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
              <Button variant="ghost" size="compact" className="bg-transparent px-2 text-xs">
          ...
          >
            <TimePickerInputGroup
              className="h-8 w-auto cursor-pointer gap-1 rounded-[var(--radius-control)] border-none bg-transparent px-2 shadow-none"
              style={
                {
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              aria-label={isPreviewOpen ? "Close billing preview" : "Open billing preview"}
            >
              <PanelRightOpen />
            </Button>
          </TooltipTrigger>
