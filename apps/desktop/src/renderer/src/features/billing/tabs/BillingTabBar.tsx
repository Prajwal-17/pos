...
const BillingTabBar = () => {
  ...
  return (
    <div className="border-b-frame bg-card flex h-9 shrink-0 items-end justify-between border-b px-2 select-none">
            ...
            <TooltipTrigger asChild>
              <DropdownMenuTrigger asChild>
                <button
                  type="button"
                  disabled={isAtLimit}
                  className="text-muted-foreground hover:text-foreground hover:bg-accent ml-1 flex size-8 shrink-0 cursor-pointer items-center justify-center self-center rounded-[var(--radius-control)] transition-colors disabled:cursor-not-allowed disabled:opacity-30"
                >
