...
import { CheckCheck, ChevronDown, PackagePlus, Plus, Search, X } from "lucide-react";
...
const LineItemsTable = () => {
  ...
  return (
    <section className="mx-3 mt-2">
      <div className="border-frame bg-card w-full overflow-visible rounded-[var(--radius-panel)] border px-2 pb-2">
        <div className="bg-card sticky top-0 z-10 flex h-11 items-center gap-2 border-b">
          <Button variant="outline" size="compact" onClick={openNewProductDialog}>
            <PackagePlus />
            New product
          </Button>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="min-w-44">
              ...
              >
                {isCountColumnVisible ? "Hide count details" : "Show count details"}
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
