          ...
          {session.addToAccounting ? (
            <>
              ...
              <button
                ...
                className="border-border bg-background text-foreground hover:bg-muted focus-visible:ring-ring disabled:bg-muted disabled:text-muted-foreground flex h-full min-w-0 flex-1 cursor-pointer items-center justify-center gap-1.5 border-l px-2 transition-colors duration-150 outline-none focus-visible:ring-2 focus-visible:ring-inset disabled:cursor-not-allowed disabled:opacity-70"
              >
            ...
            <button
              ...
              className="hover:bg-muted focus-visible:ring-ring disabled:bg-muted disabled:text-muted-foreground flex h-full w-full cursor-pointer items-center justify-center gap-1.5 px-2 outline-none focus-visible:ring-2 focus-visible:ring-inset disabled:cursor-not-allowed disabled:opacity-70"
            >
