            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={
                    direction === "due"
                      ? "border-selection-border bg-selection text-selection-foreground h-9 cursor-pointer rounded-lg border text-sm font-semibold transition-colors"
                      : "border-frame bg-card text-muted-foreground hover:bg-accent h-9 cursor-pointer rounded-lg border text-sm font-medium transition-colors"
                  }
                >
                  Add Due
                </button>
