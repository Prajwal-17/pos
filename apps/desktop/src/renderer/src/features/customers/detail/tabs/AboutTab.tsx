        ...
        <div className="flex flex-col gap-3">
          <div className="bg-muted/40 border-border/70 flex items-center justify-between gap-3 rounded-lg border px-4 py-3">
            ...
            <button
              ...
              className="text-muted-foreground hover:text-foreground hover:bg-accent flex size-9 shrink-0 items-center justify-center rounded-lg border border-transparent transition-colors"
              title="Copy ID"
            >
