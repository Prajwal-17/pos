      ...
      <div className="mb-2 flex shrink-0 items-center gap-2">
        <div className="border-border bg-card flex min-h-11 min-w-0 flex-1 items-center gap-5 rounded-(--radius-panel) border px-3 py-1.5">
          <div className="flex min-w-0 items-center gap-2">
            <span
              className="bg-secondary text-foreground flex size-7 shrink-0 items-center justify-center rounded-(--radius-control)"
            >
        ...
        <Button
          ...
          className="h-9 cursor-pointer gap-1.5 px-3 hover:bg-primary-hover"
        >
