    ...
    <>
      <div ref={dropdownRef}>
        <AnimatePresence>
          {delayedPreviewProduct && delayedPreviewProduct.imageUrl && (
            ...
            >
              ...
              >
                <div className="ring-border h-full w-full overflow-hidden rounded-[var(--radius-panel)] shadow-md ring-1">
                  <img
        ...
        <div
          ...
          className="bg-popover border-frame absolute top-[calc(100%+0.25rem)] right-[clamp(3.5rem,7%,6rem)] left-[clamp(4.25rem,7%,6rem)] z-30 flex max-h-[min(var(--search-dropdown-max-height),calc(100dvh-8rem))] flex-col overflow-hidden rounded-[var(--radius-panel)] border shadow-lg"
        >
                  ...
                  >
                    {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`group flex min-h-13 items-center gap-2 rounded-[var(--radius-control)] border px-2 py-1.5 transition-[background-color,border-color] duration-150 hover:cursor-pointer ${
