    ...
    >
      ...
      >
        <img
          ...
          className="h-16 w-auto rounded-[var(--radius-panel)] object-contain"
        />
      </motion.div>
      ...
      >
        <Button
          size="lg"
          onClick={nextStep}
          className="hover:bg-primary-hover group h-10 gap-2 rounded-[var(--radius-control)] px-6 text-sm font-semibold"
        >
          Get Started
