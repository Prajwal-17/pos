  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="bg-card w-full rounded-[var(--radius-panel)] border p-3 text-left"
      >
      ...
      >
        <Button
          ...
          className="hover:bg-primary-hover group h-10 w-full gap-2 rounded-[var(--radius-control)] text-sm font-semibold disabled:opacity-70"
        >
