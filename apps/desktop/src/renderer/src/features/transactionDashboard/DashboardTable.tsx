  ...
  return (
    <>
      <div className="flex min-h-0 flex-1 flex-col">
        ...
        {status === "pending" ? (
          <div className="bg-card border-border flex min-h-48 flex-1 items-center justify-center rounded-[var(--radius-panel)] border">
          ...
          <div className="bg-card border-border flex min-h-0 flex-1 flex-col overflow-hidden rounded-[var(--radius-panel)] border">
