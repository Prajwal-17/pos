  ...
  return (
    ...
    >
      <DialogContent
        ...
        className="flex h-[calc(100dvh-1.5rem)] max-h-[760px] w-[calc(100vw-1.5rem)] max-w-6xl min-w-0 flex-col overflow-hidden p-0"
      >
        <Tabs
          value={activeTab}
        ...
        >
          <div className="border-border bg-card grid shrink-0 grid-cols-[1fr_auto_1fr] items-center gap-3 border-b px-4 py-2">
            ...
            <div className="flex shrink-0 justify-center">
              <TabsList className="bg-secondary/60 border-border/40 flex h-9 w-full gap-1 rounded-[var(--radius-control)] border p-0.5 sm:w-fit">
                <TabsTrigger
                  value={INITIAL_TAB.INFO}
                  className="data-[state=active]:text-foreground data-[state=active]:bg-background ring-offset-background text-muted-foreground group relative flex-1 rounded-[var(--radius-control)] px-3 py-1 text-sm font-semibold transition-colors sm:flex-none"
                >
