  ...
  return (
    <main className="bg-background flex h-full min-h-0 items-center justify-center p-3">
      <section className="border-border bg-card w-full max-w-md rounded-[var(--radius-panel)] border p-4 text-center">
        ...
        <code className="border-border bg-muted text-foreground mt-3 block overflow-hidden rounded-[var(--radius-control)] border px-3 py-2 font-mono text-xs text-ellipsis whitespace-nowrap">
          {pathname}
        </code>
