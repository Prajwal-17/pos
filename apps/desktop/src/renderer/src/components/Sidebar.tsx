  ...
  const renderNavItem = (item: (typeof navLinks)[number]) => {
    ...
    return (
      <Link
        ...
        className={cn(
          "relative flex h-(--nav-row-height) w-full items-center gap-2 rounded-[var(--radius-control)] px-2 text-sm font-medium transition-colors duration-150 outline-none",
      ...
      >
        <span
          className={cn(
            "flex size-8 shrink-0 items-center justify-center rounded-[var(--radius-control)] transition-colors duration-150 [&_svg]:size-4.5",
            isActive
    ...
    >
      <div className="flex h-full flex-col">
        <div className="border-b-frame flex h-(--app-header-height) shrink-0 items-center border-b px-3">
          ...
          >
            <div className="bg-background border-border flex size-8 shrink-0 items-center justify-center rounded-[var(--radius-control)] border p-1.5">
              <img
                src={quickcartLogo}
                alt="QuickCart logo"
        ...
        <div className="flex flex-1 flex-col overflow-y-auto px-2 py-3">
          <div className="flex flex-col gap-1.5">
            <Button
              asChild
              size="lg"
              className="h-10 w-full cursor-pointer justify-center gap-2 px-3 text-sm font-semibold"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="h-9 w-full cursor-pointer justify-center gap-2 px-3 text-sm font-medium"
            >
        ...
        <div className="border-t-frame shrink-0 border-t px-2 py-2">
          <Link
            ...
            className="hover:bg-sidebar-accent flex h-11 items-center gap-2 rounded-[var(--radius-control)] px-2 transition-colors duration-150"
          >
            <div className="bg-brand-soft text-brand-foreground flex size-8 shrink-0 items-center justify-center rounded-[var(--radius-control)] text-xs font-semibold">
              {storeInitials || "QC"}
            </div>
            <div className="min-w-0">
