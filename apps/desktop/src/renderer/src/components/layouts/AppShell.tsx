...
const AppShell = () => {
  ...
  return (
    <div className="bg-background flex h-full w-full overflow-hidden">
      ...
      {usesOverlaySidebar && <Sidebar variant="overlay" />}
          ...
          <header className="bg-card border-b-frame flex h-(--app-header-height) shrink-0 items-center border-b px-3">
            <div className="flex min-w-0 items-center gap-2">
              <button
                ...
                className={cn(
                  "text-muted-foreground hover:text-foreground hover:bg-accent inline-flex size-8 shrink-0 items-center justify-center rounded-[var(--radius-control)] transition-colors outline-none",
